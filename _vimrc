...
"Activating CTRLP plugin
set runtimepath^=$HOME/vimfiles/bundle/ctrlp.vim

"windows position and size when opening
"winpos 600 200
"set lines=45 columns=150
au GUIEnter * simalt ~x "fullscreen


"shows line numbers (relative to the position of the cursor)
set number
set relativenumber
"
...
"Creates the backup files in a Temp directory
set backup
